...
dDelta3 = 0.16976 #cm copy from compressor outlet boundary layer thickness
rh3 = 1.25 # cm hub radius cm copy from compressor 
RPM = 80000 #Copy from compressor
## From cycle
AFlow1 = 24.185 # cm2
AFlow3 = 35.389 # cm2
mdot = 3.82E-01 #kg/sec
Mx1 = 3.00E-01
Mx3 = 4.00E-01
Vx1 = 172.069 # m/sec
Vx3 = 215.762 # m/sec
...
Gam1 = 1.338
Gam3 = 1.348
Rconst = 288.467 #J/(kg*K)
ht2 = 9.10E+05 # J/kg
ht3 = 8.01E+05 # J/kg

####Design parameters
NB3 = 9 #number of turbine blades
